...
condition_always = AlwaysTrueCondition(True)
...
state2.add_entering_action(lambda: print("Ta soeur en froc"))
state2.add_exiting_action(lambda: print("Ton frère en jaquette"))
...
transition_conditional = ConditionalTransition(condition_always, state1)
transition_conditional2 = ConditionalTransition(condition_always, state2)
transition_conditional3 = ConditionalTransition(condition_always, state3)
